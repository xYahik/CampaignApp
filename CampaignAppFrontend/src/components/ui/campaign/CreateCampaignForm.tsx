...
const CreateCampaignForm = () => {
  ...
  const onSubmit = async (data: z.infer<typeof FormSchema>) => {
    const result = await handleCreateCampaign(data);

    if (result) {
      toast.success("The campaign was created");
      navigate("/campaign/my");
    }
  };
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue="ON">
                    <FormControl>
                      <SelectTrigger>
